...
## Checking most efficient way of counting the number of siblings

### tl;dr

	$sibCt = $parent->children("template='Series'")->count - 1;
...
public function cardShelfmark() {
	$sibCt = $parent->children("template=Series")->count() - 1;		// line 43 (on 2023-05-16)
}
```
...
This caused an out-of-memory condition. I retested with only 10K iterations and multiplied by 10.
	...
	$sibCt = $parent->numChildren("template='Series'") - 1;

#### 2,221µs
	$sibCt = $this->siblings("template='Series'", false)->count;
