...
## Checking most efficient way of counting the number of comment-children

### tl;dr

	$commentCt = $this->children("template=Comment")->count();
...
public function cardShelfmark() {
	$commentCt = $this->children("template=Comment")->count();	// line 46 (on 2023-05-16)
}
```
...
This caused an out-of-memory condition. I retested with only 10K iterations and multiplied by 10.
	...
	$commentCt = $this->numChildren("template='Comment'");
