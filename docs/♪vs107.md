...
## Checking most efficient way of accessing an unformatted ProcessWire string

### tl;dr

	$titleShort = $box->getUnformatted("titleShort");
...
public function cardShelfmark() {
	$titleShort = $box->getUnformatted("titleShort");	// line 78 (on 2023-05-16)
}
```
