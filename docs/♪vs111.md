...
## Checking most efficient way of getting plural v. singular forms

### tl;dr

	$detail = $sibCt == 1 ? " other work" : " other works";
...
``` php
public function cardCitation() {
	$detail = … $sibCt == 1 ? " other work" : " other works";		// line 58 (on 2023-06-06)
}
```
...
#### 0.5µs
//	I had to run this 1,000,000 times and divide by 10 to get a visible result
	$detail = $sibCt == 1 ? " other work" : " other works";
...
#### 18µs
	$detail = ngettext(" other work", " other works", $sibCt);

#### 243µs
	$detail = _n(" other work", " other works", $sibCt);

#### 246µs
	$detail = $this->_n(" other work", " other works", $sibCt);
